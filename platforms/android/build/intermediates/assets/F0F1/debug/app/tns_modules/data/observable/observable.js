...
var Observable = (function () {
    ...
    Observable.fromJSON = function (json) {
        var observable = new Observable();
        observable.addPropertiesFromJSON(observable, json, false);
        return observable;
    };
    Observable.fromJSONRecursive = function (json) {
        var observable = new Observable();
        observable.addPropertiesFromJSON(observable, json, true);
        return observable;
    };
    Observable.prototype.addPropertiesFromJSON = function (observable, json, recursive) {
